...
An experimental UI has been developed for the FIREBrick called MAUI. It's based on principles from Morphological Analysis. A demo is available here: [MAUI](http://dfire.ucd.ie/maui/)
